...
banner() {
    ...
    echo -e "\e[1;32m           Telegram: https://t.me/MGMOVIEGRAM"
    echo -e "\e[4;32m   GROUP: https://t.me/MGMOVIEGRAM"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made by wasim > .update
...
do
    banner
    echo -e "\e[4;31m Please Read and choose option ❤"
    echo " "
